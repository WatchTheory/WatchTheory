...
- ~~Crafted drill down reports on weather data using Pivot tables, leveraging sorting, grouping, filtering, and slicing techniques to distill complex data.~~ <br>
- ~~Designed accompanying charts and diagrams to visually communicate trends and patterns in data.~~ <br>
- ~~Enhanced overall understanding and informing strategic decision-making.~~ <br> 
- ~~Showcasing proficiency in data analysis, visualization, and attention to detail~~  <br> 
